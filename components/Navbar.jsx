...
const Navbar = () => {
  ...
  const determineTitle = () => {
    ...
    switch (currentPath) {
      case "/":
        return "Top";
        break; // I don't know if break is needed, but let it be there.
      case "/new":
        return "New";
        break;
      case "/best":
  ...
  return (
    <div className="w-full h-fit flex bg-redCrayola rounded-lg">
      <div className="flex w-fit mt-4 ml-5 mb-5">
        <p className="text-5xl cursor-pointer font-inter400 hover:text-mantis transition duration-500 ease-in">
          {determineTitle()}
        </p>
      </div>
      ...
      <div className="flex flex-row justify-around w-[250px] lg:w-[350px] ml-6 lg:ml-10 mt-7 lg:mt-6 mb-5">
        <a href="/">
          <p className="font-inter400 text-2xl lg:text-3xl hover:text-mantis transition duration-500 ease-in">
            Top
          </p>
        </a>
